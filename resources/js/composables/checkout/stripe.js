...
export default function useStripe() {
    ...
    const getClientSecret = async () => {
        stripe.value = await loadStripe(process.env.MIX_STRIPE_TEST_PUBLIC_KEY);
    ...
    const handleSubmit = async () => {
        setLoading(true);
        const host = process.env.MIX_APP_URL + ":" + process.env.MIX_DEV_PORT;
        console.log(host);
